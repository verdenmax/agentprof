...
<figure>
<img class="shot" src="../assets/dashboard-overview.png" alt="dashboard /sessions 视图 (T19 添)">
...
<figure>
<img class="shot" src="../assets/dashboard-session.png" alt="dashboard /session/:id 详情视图 (T19 添)">
...
<figure>
<img class="shot" src="../assets/dashboard-aggregate.png" alt="dashboard /aggregate 视图 (T19 添)">
...
<figure>
<img class="shot" src="../assets/dashboard-mcp-waste.png" alt="dashboard /mcp-waste 视图 (T19 添)">
