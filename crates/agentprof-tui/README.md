...
| `views::mcp_waste` (M1.6.5) | **Scaffold only in T5.1** — `McpWasteState` (server-cursor + `unused_only` toggle) for the upcoming MCP server-waste split-pane (key `5`). Render function and key dispatch land in T5.2 / T5.3. See `docs/superpowers/specs/2026-06-08-m1.6.5-mcp-waste-design.md` §7.4 + ADR-0015 D-4 |
