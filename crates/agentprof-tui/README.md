...
| `views::turn_detail` (F1, in progress) | `TurnDetailState` state struct + pure formatters (`format_args_preview`, `wrap_args_full`, `status_sigil`); render lands in F1 Task 6 |
